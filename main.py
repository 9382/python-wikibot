...
CreateAPIFormRequest("action=login", {"lgname":username, "lgpassword":password, "lgtoken":GetTokenForType("login")}) #Set-Cookie handles this
...
if not "centralauth_User" in cookies:
    lerror(f"Failed to log-in as {username}. check the password and username are correct")
